      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {links.map((link) => (
          <Link
            key={link.label}
            href={link.href}
            className="flex w-full items-center gap-4 rounded-2xl bg-background px-4 py-3 shadow-lg md:flex-col md:p-7 md:text-center xl:gap-6 xl:rounded-3xl xl:p-8 border border-border dark:border-white/5"
          >
            <link.icon className="size-14 text-primary/50" />
            <div className="flex flex-col items-center justify-center gap-2">
