...
import { useIsMobile } from "@call/ui/hooks/use-mobile";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "w-(--sidebar-width) relative transition-[width] duration-200 ease-linear",
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "dark:bg-sidebar-inset bg-muted flex w-full flex-1 flex-col",
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("p-4.5 flex flex-col gap-2", className)}
      {...props}
    />
  );
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("p-4.5 relative flex w-full min-w-0 flex-col", className)}
      {...props}
    />
  );
}
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-inset hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-inset active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-inset data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-inset data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-10! group-data-[collapsible=icon]:p-3! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 cursor-pointer select-none active:scale-[0.98] transition-all duration-300 ease-in-out",
  {
    variants: {
      variant: {
        default: "hover:bg-sidebar-inset hover:text-sidebar-accent-foreground",
        outline:
      ...
      size: {
        ...
        xl: "h-14 text-sm group-data-[collapsible=icon]:p-0!",
      },
    },
    defaultVariants: {
      variant: "default",
